...
class GcpServiceAccount:
    ...
    def generate_service_account_payload(self):
        ...
        return {
            ...
            "client_x509_cert_url": f"https://www.googleapis.com/robot/v1/metadata/x509/{self.user_name}%40{self.project_id}.iam.gserviceaccount.com", # pylint: disable=line-too-long
        }
